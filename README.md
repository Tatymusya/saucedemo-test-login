...
- Playwright
- Pytest
- Page Object Model - абстракция уровня страницы или экрана
- Page Components - абстракция переиспользуемых компонентов, состоящих из элементов
- Page Factory - атомарные переиспользуемые элементы(самый низший уровень абстракции)
- Allure
- Docker
---
## Структура проекта
